...
static void AnnounceBeginSection(IDEActivityLogSection *section)
{
  ...
  if ([sectionTypeString isEqualToString:kDomainTypeBuildItem]) {
    PrintJSON(EventDictionaryWithNameAndContent(kReporter_Events_BeginBuildCommand,
    ...
    PrintJSON(EventDictionaryWithNameAndContent(kReporter_Events_BeginBuildTarget,
...
static void AnnounceEndSection(IDEActivityLogSection *section)
{
  ...
  if ([sectionTypeString isEqualToString:kDomainTypeBuildItem]) {
    PrintJSON(EventDictionaryWithNameAndContent(kReporter_Events_EndBuildCommand,
    ...
    NSString *configuration = nil;
    GetProjectTargetConfigurationFromHeader(section.title, &project, &target, &configuration);
    PrintJSON(EventDictionaryWithNameAndContent(kReporter_Events_EndBuildTarget,
