...
/**
 This file is shared by otest-query and otest-shim.  If we start sharing more
 functions between these projects, we should rename this file to a more generic
 name and put those here.
 */
