...
@interface XCTestSuiteEventStateTests : XCTestCase

@end

@implementation XCTestSuiteEventStateTests

- (void)testInitWithEvent
{
  XCTestSuiteEventState *state =
    [[[XCTestSuiteEventState alloc] initWithName:@"ATestSuite"] autorelease];
...
- (void)testPublishFromStarted
{
  ...
  XCTestSuiteEventState *state =
  [[[XCTestSuiteEventState alloc] initWithName:@"ATestSuite" reporters:@[eventBuffer]] autorelease];
...
- (void)testTestDuration
{
  XCTestSuiteEventState *state =
    [[[XCTestSuiteEventState alloc] initWithName:@"ATestSuite"] autorelease];
  XCTestEventState *testAState =
  [[[XCTestEventState alloc] initWithInputName:@"ATestClass/aTestMethod"] autorelease];
  XCTestEventState *testBState =
  [[[XCTestEventState alloc] initWithInputName:@"ATestClass/bTestMethod"] autorelease];
...
- (void)testAddTests
{
  ...
  XCTestEventState *testBState =
    [[[XCTestEventState alloc] initWithInputName:@"ATestClass/bTestMethod"] autorelease];
  XCTestEventState *testCState =
    [[[XCTestEventState alloc] initWithInputName:@"ATestClass/cTestMethod"] autorelease];
