...
@interface XCTestEventStateTests : XCTestCase
@end

@implementation XCTestEventStateTests

- (void)testInitWithInputName
{
  XCTestEventState *state =
    [[[XCTestEventState alloc] initWithInputName:@"ATestClass/aTestMethod"
...
{
  XCTAssertThrowsSpecific([[[XCTestEventState alloc] initWithInputName:@"ATestClassaTestMethod"
                                                            reporters: @[]] autorelease],
...
- (void)testPublishFromStarted
{
  ...
  XCTestEventState *state = [[[XCTestEventState alloc] initWithInputName:@"ATestClass/aTestMethod"
...
- (void)testOutput
{
  EventBuffer *eventBuffer = [[[EventBuffer alloc] init] autorelease];
  XCTestEventState *state =
  [[[XCTestEventState alloc] initWithInputName:@"ATestClass/aTestMethod" reporters:@[eventBuffer]] autorelease];
