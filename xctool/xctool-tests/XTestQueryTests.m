...
@interface XTestQueryTests : XCTestCase
@end

@implementation XTestQueryTests
...
- (void)testCanQueryClassesFromOSXBundle
{
  ...
  XCTestQueryRunner *runner = [[[XCOSXLogicTestQueryRunner alloc] initWithBuildSettings:buildSettings
...
- (void)testCanQueryClassesFromOSXBundle_AppTests
{
  ...
  XCTestQueryRunner *runner = [[[XCOSXAppTestQueryRunner alloc] initWithBuildSettings:buildSettings
                                                                                  withCpuType:CPU_TYPE_ANY] autorelease];
  NSArray *classes = [runner runQueryWithError:&error];
  assertThat(error, is(nilValue()));
  assertThat(classes,
...
- (void)testCanQueryClassesFromIOSBundle
{
  ...
  XCTestQueryRunner *runner = [[[XCIOSLogicTestQueryRunner alloc] initWithBuildSettings:buildSettings
                                                                                    withCpuType:CPU_TYPE_ANY] autorelease];
  NSArray *classes = [runner runQueryWithError:&error];
...
- (void)testCanQueryTestCasesForIOSKiwiBundle_XCTest_AppTests
{
  ...
  XCTestQueryRunner *runner = [[[XCIOSAppTestQueryRunner alloc] initWithBuildSettings:buildSettings
                                                                                  withCpuType:CPU_TYPE_ANY] autorelease];
  NSArray *cases = [runner runQueryWithError:&error];
  assertThat(cases, equalTo(@[
