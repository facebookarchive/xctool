...
@interface XCEventStateTests : XCTestCase
@end

@implementation XCEventStateTests

- (void)testParseEvent
{
  XCEventState *state = [[[XCEventState alloc] initWithReporters: @[]] autorelease];
...
- (void)testPublishWithEvent
{
  ...
  XCEventState *state = [[[XCEventState alloc] initWithReporters:@[eventBuffer]] autorelease];
