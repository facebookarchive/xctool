...
@interface XCTestRunnerTests : XCTestCase
@end

@implementation XCTestRunnerTests

#pragma mark iOS Tests

- (void)runTestsForRunner:(XCTestRunner *)runner
...
- (void)testArgsAndEnvArePassedToIOSApplicationTest
{
  ...
  XCTestRunner *runner = TestRunner([XCIOSAppTestRunner class], testSettings);
...
- (void)testArgsAndEnvArePassedToIOSLogicTest
{
  ...
  XCTestRunner *runner = TestRunner([XCIOSLogicTestRunner class], testSettings);
  [self runTestsForRunner:runner
...
- (void)testArgsAndEnvArePassedToOSXApplicationTest
{
  ...
  XCTestRunner *runner = TestRunner([XCOSXAppTestRunner class], testSettings);
  [self runTestsForRunner:runner
           andReturnTasks:&launchedTasks];
...
- (void)testArgsAndEnvArePassedToOSXLogicTest
{
  ...
  XCTestRunner *runner = TestRunner([XCOSXLogicTestRunner class], testSettings);
  [self runTestsForRunner:runner
           andReturnTasks:&launchedTasks];
...
- (void)testTestArgumentsAlwaysIncludesCommonItems
{
  ...
  XCTestRunner *runner = TestRunner([XCTestRunner class], testSettings);
...
- (void)testTestSpecifierIsSelfWhenRunningAllTestsInLogicTestBundle
{
  ...
  XCTestRunner *runner = TestRunnerWithTestList([XCTestRunner class], testSettings, @[@"Cls1/testA", @"Cls2/testB"]);
...
- (void)testTestSpecifierIsInvertedTestListWhenRunningSpecificTests
{
  ...
  XCTestRunner *runner = TestRunnerWithTestLists([XCTestRunner class],
                                                     testSettings,
                                                     @[@"Cls1/testA"],
...
- (void)testRunnerIsRunningAllTestsEvenIfCrashed
{
  ...
  FakeXCTestRunner *runner = TestRunnerWithTestList([FakeXCTestRunner class],
                                                        testSettings,
...
- (void)testClassNameDiscoveryFiltering
{
  ...
  assertThat([XCTestRunner filterTestCases:testCases withSenTestList:@"All" senTestInvertScope:NO],
             equalTo(testCases));
  assertThat([XCTestRunner filterTestCases:testCases withSenTestList:@"Cls1" senTestInvertScope:NO],
             equalTo(@[
                     @"Cls1/test1",
                     @"Cls1/test2",
                     @"Cls1/test3",
                     ]));
  assertThat([XCTestRunner filterTestCases:testCases withSenTestList:@"Cls1" senTestInvertScope:YES],
             equalTo(@[
                     @"Cls2/test1",
                     @"Cls2/test2",
                     @"Cls3/test1",
                     ]));
  assertThat([XCTestRunner filterTestCases:testCases withSenTestList:@"Cls1,Cls2/test1,Cls3" senTestInvertScope:NO],
             equalTo(@[
                     @"Cls1/test1",
                     @"Cls1/test2",
                     @"Cls1/test3",
  ...
  assertThat([XCTestRunner filterTestCases:testCases withSenTestList:@"Cls1,Cls2/test1,Cls3" senTestInvertScope:YES],
             equalTo(@[
                     @"Cls2/test2",
                     ]));
}
