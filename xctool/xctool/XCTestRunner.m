...
- (BOOL)runTests
{
  ...
  XCTestSuiteEventState *testSuiteState = nil;
  ...
  while (!testSuiteState || [[testSuiteState unstartedTests] count]) {
    ...
    XCTestSuiteEventState *suiteState = [testRunState testSuiteState];
    ...
    [unstartedTests enumerateObjectsUsingBlock:^(XCTestEventState *obj, NSUInteger idx, BOOL *stop) {
