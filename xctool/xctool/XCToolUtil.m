 ...
 */
static void AddSDKToDictionary(NSMutableDictionary *dict, NSScanner *scanner,
                        NSString *sdk) {
...
NSDictionary *GetAvailableSDKsInfo()
{
  ...
  while (![scanner isAtEnd]) {
    ...
    NSString *sdkVersion = [str substringWithRange:[match[0]
                                      rangeAtIndex:1]];
