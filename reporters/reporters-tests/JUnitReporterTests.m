...
- (void)testTestResults {
  ...
  for (NSXMLDocument *doc in @[expectedXML, resultingXML]) {
    ...
    // Trim leading & trailing whitespace in each line of the <system-out> tags
    ...
    for (NSXMLElement *systemOutElement in systemOutElements) {
      ...
      STAssertEquals([innerText kind], NSXMLTextKind, @"The <system-out> tag child shoudl be a text node.");
      ...
      for (NSString *line in lines) {
        ...
        // First trim the end, then the beginning.
